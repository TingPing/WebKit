...
WEBKIT_OPTION_DEFAULT_PORT_VALUE(USE_GLYCIN PUBLIC OFF)
...
if (USE_GLYCIN)
    find_package(Glycin 2.0)
    if (NOT Glycin_FOUND)
        message(FATAL_ERROR "libglycin 2.0 is required for USE_GLYCIN.")
    endif ()
endif ()

# The built-in image decoders are not built when USE_GLYCIN is enabled, but the
# USE_AVIF and USE_JPEGXL options still declare that those formats are supported.
if (USE_JPEGXL AND NOT USE_GLYCIN)
...
if (USE_AVIF AND NOT USE_GLYCIN)
